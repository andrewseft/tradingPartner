...
<div class="container-fluid pt-5">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <a href="{{route('admin.plan')}}" class="btn btn-light ml-3 mt-3">{{__('Back')}}</a>
                    <div class="body">
...
<script>
    $(".dd").nestable({
        protectRoot: true,
        maxDepth: 1
    }),$(".dd").on("change",function(){var a=$(this),e=window.JSON.stringify($(a).nestable("serialize"));$.ajax({url:"{{route('admin.plan.sortableSave')}}",data:{data:e},type:"post",success:function(a){}})});
</script>
@stop