        ...
        <div class="card card-statistics">
            ...
            <div class="card-body">
                <div class="tab nav-bt">
                    ...
                    {{Form::hidden($data->code, $data->code, ['id' => 'hidden', 'name' => 'code', 'class' => 'text text-hidden'])}}
                    {{Form::hidden($data->id, $data->id, ['id' => 'hidden', 'name' => 'id', 'class' => 'text text-hidden'])}}
                    @include('admin.language.from')
                        <div class="form-group">
                            <div class="col-sm-12">
                                <a href="{{route('admin.language')}}" class="btn btn-light mb-3 float-right ml-3">Back</a>
                                {{ Form::submit(__('Update'),['class'=>'btn btn-primary mb-3 float-right']) }}
                            </div>
                        </div>
                    {{ Form::close() }}
                </div>
