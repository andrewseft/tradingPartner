            ...
            <div class="col-lg-8 col-md-12">
                <div class="card">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="nav-item"><a href="{{route('admin.order.userOrder',['id' => Helper::encode($user->id)])}}" class="nav-link active">{{__('Order')}}</a></li>
                                    ...
                                    @if($data->count() || $request->query('keyword') || $request->query('created_at_from') || $request->query('created_at_to'))
                                        <div class="row no-gutters">
                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                <div class="card">
                                                    <div class="body">
                                                        {{ Form::model($orderData, ['url' => route('admin.order.userOrder',['id' => Helper::encode($user->id)]),'class' => 'search_form','method'=>'get']) }}
                                                            <div class="row table_search_form align-items-center">
                                                                ...
                                                                <div class="col py-1">{{ link_to( route('admin.order.userOrder',['id' => Helper::encode($user->id)]),'<i class="fas fa-redo-alt"></i>',['class'=>'btn btn-danger'],null, false)}}</div>
                                                            </div>
                                                        {{ Form::close() }}
                                                    </div>
                                                </div>
